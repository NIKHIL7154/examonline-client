...
function SystemAnalysis() {
    return (
        <div className="grid grid-cols-2 gap-[20px] grid-rows-auto">
            ...
            {/* Row 1 */}
            <div className="h-[150px] rounded-[15px] col-span-full bg-[#D9D9D9] 
            ...
            {/* Row 2 */}
            <div className="h-[200px] p-[30px] rounded-[15px] flex flex-col  items-center justify-center             
            gap-4 bg-[#D9D9D9]">
            ...
            <div className="h-[200px] p-[30px] rounded-[15px] flex flex-col  items-center bg-[#D9D9D9] justify-center            
            gap-4">
            ...
            {/* Row 3 */}
            <div className="bg-[#D9D9D9] h-[165px] rounded-[15px] col-span-full flex justify-center gap-8 items-center px-[30px]">
                <BarChart />
                <h3 className="text-xl">Averate <br /> Time</h3>
            </div>

            {/* Row 4 */}
            <div className="h-[165px] rounded-[15px] col-span-full flex flex-col pt-[10px] px-[30px] bg-[#D9D9D9]">
